...
export default defineConfig({
  ...
  testMatch: [/experience-.*\.spec\.ts/, /workspace-chrome-continuity\.spec\.ts/, /workspace-toolbar-feedback\.spec\.ts/, /warehouse-label-v4\.spec\.ts/, /warehouse-label-print\.spec\.ts/],
